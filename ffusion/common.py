...
def fusion(func):
    ...
    def new_f(params):
        ...
        factors, err_history = func(engine, X, Xt, mask, G, S, TrX, k=k, max_iter=max_iter, verbose=verbose)
        t1 = time.time()
...
def transform(func):
    def new_f(params):
        ...
        factors = func(engine, X, mask, G, S, Gi, TrX, k=k, max_iter=max_iter, verbose=verbose)
        err_history = []
